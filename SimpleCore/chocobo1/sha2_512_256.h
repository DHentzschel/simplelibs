...
namespace SHA2_512_256_NS
{
	class SHA2_512_256
	{
		...
		public:
			...
			CONSTEXPR_CPP17_CHOCOBO1_HASH SHA2_512_256& addData(const void *ptr, const long int length);
			template <typename T, std::size_t N>
	...
	CONSTEXPR_CPP17_CHOCOBO1_HASH SHA2_512_256& SHA2_512_256::addData(const void *ptr, const long int length)
	{
