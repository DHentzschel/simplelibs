...
RAPIDJSON_NAMESPACE_BEGIN
    ...
    */
    ...
    class GenericMemberIterator {
        ...
        typedef typename internal::MaybeAddConst<Const, PlainType>::Type
        ValueType;
    ...
    public:
        ...
        typedef GenericMemberIterator<false, Encoding, Allocator>
        NonConstIterator;
...
struct GenericMemberIterator<true,Encoding,Allocator> {
    ...
    /*!
        ...
        \see AStringRef, GenericValue::SetString
    */
    ...
    struct GenericStringRef {
        ...
        /*!
            ...
            \ref AStringRef(const CharType*) by inferring the string \ref length
        ...
        GenericStringRef(const CharType* str,SizeType len)
            : s(RAPIDJSON_LIKELY(str) ? str : emptyString),
              length(len)
        {
            RAPIDJSON_ASSERT(str != nullptr || len == 0u);
        }
    ...
    */
    template <typename CharType>
    GenericStringRef<CharType> AStringRef(const CharType* str)
    {
    ...
    */
    template <typename CharType>
    GenericStringRef<CharType> AStringRef(const CharType* str,size_t length)
    {
...
*/
template<typename CharType>
inline GenericStringRef<CharType> AStringRef(const std::basic_string<CharType>& str) {
    ...
    namespace internal
    {
        template <typename T, typename Encoding = void, typename Allocator =
                  void>
        ...
        struct IsGenericValueImpl<
                T, typename Void<typename T::EncodingType>::Type, typename Void<
                    typename T::AllocatorType>::Type>
            : IsBaseOf<GenericValue<
                           typename T::EncodingType, typename T::AllocatorType>,
                       T>::Type {
        };
    ...
    namespace internal
    {
        ...
        struct TypeHelper<ValueType, const typename ValueType::Ch*> {
            typedef const typename ValueType::Ch* AStringType;
            ...
            static AStringType Get(const ValueType& v)
            {
                return v.GetString();
            }

            static ValueType& Set(ValueType& v,const AStringType data)
            {
                return v.SetString(typename ValueType::StringRefType(data));
            }

            static ValueType& Set(ValueType& v,
                                  const AStringType data,
...
struct TypeHelper<ValueType, std::basic_string<typename ValueType::Ch> > {
    typedef std::basic_string<typename ValueType::Ch> AStringType;
    static bool Is(const ValueType& v) { return v.IsString(); }
    static AStringType Get(const ValueType& v) { return AStringType(v.GetString(), v.GetStringLength()); }
    static ValueType& Set(ValueType& v, const AStringType& data, typename ValueType::AllocatorType& a) { return v.SetString(data, a); }
};
#endif
    ...
    */
    ...
    public:
        ...
        typedef GenericStringRef<Ch> AStringRefType;

        //!< Reference to a constant string
        typedef typename GenericMemberIterator<false, Encoding, Allocator>::
        Iterator MemberIterator; //!< Member iterator for iterating in object.
        typedef typename GenericMemberIterator<true, Encoding, Allocator>::
        ...
        */
                     ...
                     bool copyConstStrings = false)
        {
            ...
            case kObjectType:
            {
                ...
                Member* lm     = reinterpret_cast<Member*>(allocator.
                    Malloc(count * sizeof(Member)));
                const typename GenericValue<Encoding, SourceAllocator>::Member*
                    rm          = rhs.GetMembersPointer();
                for (SizeType i = 0; i < count; i++) {
                    new(&lm[i].name) GenericValue(rm[i].name,
                                                  allocator,
                                                  copyConstStrings);
                    new(&lm[i].value) GenericValue(rm[i].value,
                                                   allocator,
                                                   copyConstStrings);
                }
            ...
            case kArrayType:
            {
                ...
                GenericValue* le = reinterpret_cast<GenericValue*>(allocator.
                    Malloc(count * sizeof(GenericValue)));
                const GenericValue<Encoding, SourceAllocator>* re = rhs.
                    GetElementsPointer();
                for (SizeType i = 0; i < count; i++)
                    new(&le[i]) GenericValue
                        (re[i], allocator, copyConstStrings);
            ...
            case kStringType:
                if (rhs.data_.f.flags == kConstStringFlag && !copyConstStrings
                    ...
                    SetStringRaw(StringRef(rhs.GetString(),
                                           rhs.GetStringLength()),
                                 allocator);
                break;
            default:
    ...
    explicit GenericValue(bool b) RAPIDJSON_NOEXCEPT
            ...
            : data_()
        {
            data_.n.i64   = i;
            data_.f.flags = (i >= 0) ?
                                (kNumberIntFlag | kUintFlag | kUint64Flag) :
                                kNumberIntFlag;
        }
            ...
            : data_()
        {
            ...
            else if (i64 >= static_cast<int64_t>(RAPIDJSON_UINT64_C2(0xFFFFFFFF,
                         0x80000000)))
                data_.f.flags |= kIntFlag;
        }
    ...
    GenericValue(const std::basic_string<Ch>& s, Allocator& allocator) : data_() { SetStringRaw(StringRef(s), allocator); }
        ...
        */
        ...
        /*! \tparam T Either \ref Type, \c int, \c unsigned, \c int64_t, \c uint64_t
            ...
            \note The source type \c T explicitly disallows all pointer types,
                ...
                \ref AStringRef() (to explicitly mark the pointer as constant) instead.
        ...
        */
        ...
        GenericValue& CopyFrom(
            ...
            bool copyConstStrings = false)
        {
            RAPIDJSON_ASSERT(static_cast<void*>(this) != static_cast<void const*
                >(&rhs));
            this->~GenericValue();
        ...
        */
        template <typename SourceAllocator>
        bool operator==(
            const GenericValue<Encoding, SourceAllocator>& rhs) const
        {
            ...
            case kObjectType: // Warning: O(n^2) inner-loop
                ...
                for (ConstMemberIterator lhsMemberItr = MemberBegin();
                    ...
                    typename RhsType::ConstMemberIterator rhsMemberItr = rhs.
                        FindMember(lhsMemberItr->name);
                    if (rhsMemberItr == rhs.MemberEnd() || lhsMemberItr->value
                        != rhsMemberItr->value)
                        return false;
                }
                return true;
            ...
            case kStringType:
                return AStringEqual(rhs);

            case kNumberType:
            {
                if (IsDouble() || rhs.IsDouble()) {
                    double a = GetDouble();
                    // May convert from integer to double.
    ...
    bool operator==(const std::basic_string<Ch>& rhs) const { return *this == GenericValue(StringRef(rhs)); }
        ...
        */
        ...
        bool IsLosslessDouble() const
        {
            ...
            if (IsUint64()) {
                ...
                return (d >= 0.0)
                       && (d < static_cast<double>((std::numeric_limits<uint64_t
                           >::max)()))
            ...
            if (IsInt64()) {
                ...
                return (d >= static_cast<double>((std::numeric_limits<int64_t>::
                            min)()))
                       && (d < static_cast<double>((std::numeric_limits<int64_t>
                               ::max)()))
        ...
        */
        template <typename T>
        RAPIDJSON_DISABLEIF_RETURN((internal::NotExpr<internal::IsSame<typename
            internal::RemoveConst<T>::Type, Ch> >),(GenericValue&)) operator[](
            T* name)
        {
        ...
        template <typename T>
        RAPIDJSON_DISABLEIF_RETURN((internal::NotExpr<internal::IsSame<typename
            internal::RemoveConst<T>::Type, Ch> >),(const GenericValue&))
    ...
    */
    GenericValue& AddMember(GenericValue& name, std::basic_string<Ch>& value, Allocator& allocator) {
        ...
        /*! \tparam T Either \ref Type, \c int, \c unsigned, \c int64_t, \c uint64_t
            ...
            \note The source type \c T explicitly disallows all pointer types,
                ...
                AddMember(StringRefType, AStringRefType, Allocator&).
                All other pointer types would implicitly convert to \c bool,
        ...
        */
        template <typename T>
        RAPIDJSON_DISABLEIF_RETURN((internal::OrExpr<internal::IsPointer<T>,
            internal::IsGenericValue<T> >), (GenericValue&)) AddMember(
            GenericValue& name,
            T value,
            Allocator& allocator)
        {
        ...
        GenericValue& AddMember(StringRefType name,
                                GenericValue&& value,
                                Allocator& allocator)
        {
            GenericValue n(name);
    ...
    bool RemoveMember(const std::basic_string<Ch>& name) { return RemoveMember(GenericValue(StringRef(name))); }
        ...
        */
        MemberIterator RemoveMember(MemberIterator m)
        {
            ...
            RAPIDJSON_ASSERT(GetMembersPointer() != nullptr);
    ...
    bool EraseMember(const std::basic_string<Ch>& name) { return EraseMember(GenericValue(StringRef(name))); }
        ...
        GenericValue& Reserve(SizeType newCapacity,Allocator& allocator)
        {
            ...
            if (newCapacity > data_.a.capacity) {
                SetElementsPointer(reinterpret_cast<GenericValue*>(allocator.
                                       Realloc(GetElementsPointer(),
                                               data_.a.capacity * sizeof(
                                                   GenericValue),
        ...
        */
        template <typename T>
        RAPIDJSON_DISABLEIF_RETURN((internal::OrExpr<internal::IsPointer<T>,
            internal::IsGenericValue<T> >), (GenericValue&)) PushBack(
            T value,
            Allocator& allocator)
        {
            GenericValue v(value);
        ...
        */
        ValueIterator Erase(ConstValueIterator first,ConstValueIterator last)
        {
            ...
            RAPIDJSON_ASSERT(GetElementsPointer() != nullptr);
        ...
        */
        ...
        const Ch* GetString() const
        {
            ...
            return (data_.f.flags & kInlineStrFlag) ?
                       data_.ss.str :
                       GetStringPointer();
        }
    ...
    */
        ...
        bool Accept(Handler& handler) const
        {
            ...
            case kObjectType:
                if (RAPIDJSON_UNLIKELY(!handler.StartObject()))
                    return false;
                for (ConstMemberIterator m = MemberBegin(); m != MemberEnd(); ++
                     m) {
                    RAPIDJSON_ASSERT(m->name.IsString());
                    // User may change the type of name by MemberIterator.
                    if (RAPIDJSON_UNLIKELY(!handler.Key(m->name.GetString(), m->
                        name.GetStringLength(), (m->name.data_.f.flags &
                            kCopyFlag) != 0)))
                        return false;
    ...
    private:
        ...
        struct ShortString {
            enum {
                MaxChars = sizeof(static_cast<Flag*>(nullptr)->payload) / sizeof
                           (Ch),
                MaxSize = MaxChars - 1,
                LenPos = MaxSize
            };
        ...
        void SetArrayRaw(GenericValue* values,
                         SizeType count,
                         Allocator& allocator)
        {
            data_.f.flags = kArrayFlag;
            if (count) {
                GenericValue* e = static_cast<GenericValue*>(allocator.
                    Malloc(count * sizeof(GenericValue)));
        ...
        void SetObjectRaw(Member* members,SizeType count,Allocator& allocator)
        {
            data_.f.flags = kObjectFlag;
            if (count) {
                Member* m = static_cast<Member*>(allocator.
                    Malloc(count * sizeof(Member)));
                SetMembersPointer(m);
        ...
        void SetStringRaw(StringRefType s,Allocator& allocator)
        {
            ...
            if (ShortString::Usable(s.length)) {
                ...
                data_.s.length = s.length;
                str            = static_cast<Ch *>(allocator.
                    Malloc((s.length + 1) * sizeof(Ch)));
...
*/
    ...
    */
        ...
        \see Swap()
     */
        friend void swap(GenericDocument& a,
    ...
    */
    ...
    //! Parse JSON text from an input stream (with Encoding conversion)
        ...
        \return The document itself for fluent API.
    */
        template <unsigned parseFlags, typename SourceEncoding, typename
                  InputStream>
    ...
    */
    ...
    public:
        ...
        {
            if (copy)
                new(stack_.template Push<ValueType>()) ValueType(str,
                                                                 length,
                                                                 GetAllocator());
            else
        ...
        bool AString(const Ch* str,SizeType length,bool copy)
        {
            if (copy)
                new(stack_.template Push<ValueType>()) ValueType(str,
                                                                 length,
        ...
        {
            return AString(str, length, copy);
        }

        bool EndObject(SizeType memberCount)
        {
            typename ValueType::Member* members = stack_.template Pop<typename
                ValueType::Member>(memberCount);
            stack_.template Top<ValueType>()->SetObjectRaw(members,
                                                           memberCount,
                                                           GetAllocator());
            return true;
        }
        ...
        bool EndArray(SizeType elementCount)
        {
            ...
            stack_.template Top<ValueType>()->SetArrayRaw(elements,
                                                          elementCount,
                                                          GetAllocator());
            return true;
        }
        ...
        void ClearStack()
        {
            if (Allocator::kNeedFree)
                while (stack_.GetSize() > 0)
                    // Here assumes all elements in stack array are GenericValue (Member is actually 2 GenericValue objects)
...
*/
    ...
    public:
        ...
        typedef typename ValueType::StringRefType AStringRefType;
        ...
        template <typename T>
        RAPIDJSON_DISABLEIF_RETURN((internal::OrExpr<internal::IsPointer<T>,
            internal::IsGenericValue<T> >), (const GenericArray&)) PushBack(
            T value,
            AllocatorType& allocator) const
        {
            value_.PushBack(value, allocator);
...
*/
    ...
    GenericObject AddMember(ValueType& name, std::basic_string<Ch>& value, AllocatorType& allocator) const { value_.AddMember(name, value, allocator); return *this; }
        ...
        template <typename T>
        RAPIDJSON_DISABLEIF_RETURN((internal::OrExpr<internal::IsPointer<T>,
            internal::IsGenericValue<T> >), (ValueType&)) AddMember(
            ValueType& name,
            T value,
            AllocatorType& allocator) const
        {
        ...
        template <typename T>
        RAPIDJSON_DISABLEIF_RETURN((internal::OrExpr<internal::IsPointer<T>,
            internal::IsGenericValue<T> >), (GenericObject)) AddMember(
            AStringRefType name,
            T value,
            AllocatorType& allocator) const
        {
